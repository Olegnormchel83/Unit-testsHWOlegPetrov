...
//        checkingHero(emmett);
    ...
    public static int sum(int a, int b) {
        assert Integer.MAX_VALUE - a >= b : "Переполнение разряда";
        return a + b;
    }
    ...
    public static void checkingHero(Hero hero) {
        ...
        assertThat(hero.getArmorStrength()).isBetween(30, 70).isEqualTo(50);
        assertThat(hero.getWeapon()).isEqualTo("sword");
        assertThat(hero.getBag()).isNotEmpty().hasSize(3).contains("Bow").contains("Axe").contains("Gold");
